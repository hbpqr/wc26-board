window.DASH_DATA = {
 ...
 "slip": {
  ...
  "status": "**已出票72元(见持仓区)。** 厄腿已查实=厄瓜多尔让球净胜4球+(让-3@3.40·全国统一盘)。复盘建议:德国是本轮最强预测但只能串,你的票里德国只通过【2串1德日】和【3串1德日厄】兑现——都得日本同时赢;日本久保伤缺有风险,若日本没赢,德日两串(40元)全死,只剩荷单回血。建议补一张【德×荷 2串1 约16元】给德国第二条路径,对冲日本风险。",
  "detail": "已下注4票(72元):①荷兰胜单12@1.53 ②日本胜单20@1.37 ③2串1德×日24@1.836 ④3串1德×日×厄让球净胜4+(让-3)16@6.24。最高全中+117.64,全挂-72。\n复盘缺口:德国(最强·68%)无脱离日本的兑现路径→建议加德×荷2串1对冲日本久保风险。",
  "items": [
   {
    "num": "周六033",
    "pick": "荷兰胜·单关【已出票】",
