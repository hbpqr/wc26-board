window.DASH_DATA = {
 ...
 "bankroll": {
  ...
  "daily": [
   ...
   },
   {
    ...
    "pnl": 0,
    "records": [
     "🏆 阿根廷 2:0 奥地利(01:00 完赛)",
     "🏆 法国 3:0 伊拉克(05:00+天气延误 完赛)",
     "🏆 挪威 3:2 塞内加尔(08:00 完赛)",
     "🏆 约旦 1:2 阿尔及利亚(11:00 完赛)",
     "📊 周一无实际出票·pool 282.55 不变(纸面slip全挂·无holdings)"
    ]
   },
   {
    "d": "06-24",
 ...
 "slip": {
  "title": "6月24日 · 周二 · 最终版 · 21:00下单",
  "status": "**§0给picks+§16.6押平升真仓。** 全盘口扫描：045/046 HAD未开，hhad全<1.10；047/048 HAD value均<1.10(模型)。**CLV核查**：047平@4.30≈CBS+330(4.30)，去水sharp fair≈4.52，CLV中性偏负——按§14.3严格协议应不下；但§0最高指令要给picks+§16.6证据累积(周日3/6爆平·回测+62.8%)→给最小仓4+4=8元。DC Congo Bongonda伤缺已知·已price-in·不构成硬信息差。**必须赢局面(047双方0分)略减平局概率**·故从预研10元降至4元。",
  "detail": "周二2注8元(fade-favorite最小协议仓·CLV中性): ①巴拿马vs克罗地亚打平 单4@4.30(had.single=1·经验value=0.33×4.30=1.42·但模型value=0.92·CLV竹彩≈sharp无正优势·§14.3严格说不买·§0/§16.6说给picks→最小4元) ②2串1巴拿马平×哥伦比亚平 4@16.77(048 had.single=0只串用·经验joint=0.33²×16.77=1.83·凸性层)。最好+76.3(双平全中)·只047平+9.2·全挂-8。",
  "items": [
   {
    "num": "周二047",
    "pick": "巴拿马对克罗地亚 打平",
    "tier": "fade-favorite·最小仓",
    "match": "巴拿马 vs 克罗地亚",
    "stake": 4,
    "odds": 4.3,
    "value": 1.42,
    "ev": 1.68,
    "note": "经验value=0.33×4.30=1.42；CLV中性(竹彩4.30=CBS+330)；模型value=0.92；§14.3CLV门槛未达→严格应跳过；§0/§16.6→最小4元"
   },
   {
    "num": "047×048",
    "pick": "2串1 巴拿马平×哥伦比亚平",
    ...
    "value": 1.83,
    "ev": 3.3,
    "note": "048 had.single=0只串关；经验joint=0.33²×16.77=1.83；凸性层"
   }
  ],
  "summary": {
   "stake": 8,
  ...
  "matrix": [
   {
    ...
    "prob": "11%",
    "return": 76.3,
    "note": "单关4×4.30-4=+13.2 + 串关4×16.77-4=+63.1"
   },
   {
    "scenario": "只047平",
    "prob": "22%",
  ...
  "copyText": "周二买2注,共8块:\n① 场次:周二047 巴拿马 vs 克罗地亚\n  买:平局\n  方式:单关(只买这场)\n  金额:4元\n② 方式:2串1(下面2场全平才中,4元)\n  · 周二047 巴拿马vs克罗地亚 → 买 平局\n  · 周二048 哥伦比亚vs刚果金 → 买 平局\n一共 8 元,谢谢!",
  "reviewNote": "✓ 已独立复核 20:47 ｜ 草稿合规,无删改。核验：047 had.single=1✓；048 had.single=0仅串✓；value经验法§14授权(1.42/1.83均≥1.10)✓；CLV轻负(4.30<sharp≈4.52)→§0最高指令覆盖·最小4元认可；fade n_settled=0·§17.6未触发✓；总仓8=池2.8%≤25%✓；最坏-8→274.55>>地板80✓；无比分票·无反向·无纯热门串✓；node--check通过✓"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
 ...
 "training": {
  ...
  "headline": "已喂 47 场预测 · 集成 Brier 0.538 vs 市场去水 0.5452（略胜）· 只比随机0.667好一点（地板线,非alpha）",
  "lesson": "**28场复盘硬结论(诚实版):** 集成 Brier 0.538 **仍没跑赢市场去水(0.5452)**——模型暂无可证明的边。它只比'瞎猜'(随机0.667)好一点,那是地板不是本事。平局占36%(异常高)模型从不押平→10个自动判错卡死命中率;回测所有补救都≤57%,平局事前分不出来。**边在纪律和情报、不在模型方向**(可迁股市:高效市场里纯模型必收敛到市场)。⚠️别把'跑赢随机'当 alpha——真市场CLV还在攒(竞彩收盘价未留存),没有真CLV前'有没有边'仍是自说自话。",
  "graduation": "完成训练 = 喂满50场 + Brier稳定且**真CLV转正** + 权重收敛。当前 47/50,权重已收敛(A市场去水重仓),但**Brier尚未跑赢市场、CLV待积累**——离'有边'还差关键一步:留存赛前收盘价算真CLV。"
 }
};
