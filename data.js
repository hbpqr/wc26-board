window.DASH_DATA = {
 ...
 "slip": {
  ...
  "status": "**Final Call 20:31 定稿。** 锚:乌拉圭68.6%(市场)/74.4%(模型)、比利时70.0%(模型+市场共识)、西班牙让2球净胜3+~58%(硬币·只进彩票腿)。040新西兰胜价值1.09临界<1.10跳过。情报终核通过:比利时Doku+Debast出局已price、乌拉圭Araujo+De Arrascaeta出局已price、佛得角首战0:0逼平西班牙已price、西班牙亚马尔45分钟替补方案已price。赔率终盘更新:2串1@1.63(原1.66)/3串1@2.55(原2.68)。fade-favorite本轮0注(038负CLV、039无sharp参考、040 conf<60%)。",
  ...
  "reviewNote": "✓ Final Call 20:31:锚已报(乌68.6%市场/74.4%模型、比70.0%)、谁赢vs赢几个分离(西让2按58%进彩票)、040新西兰价值1.09<1.10跳过、仍给picks不空仓。情报终核通过全场次。赔率更新至终盘(2串1@1.63/3串1@2.55)。fade-favorite本轮0注。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
