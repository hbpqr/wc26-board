window.DASH_DATA = {
 ...
 "bankroll": {
  ...
  "note": "2万是北极星(方向)。架构=CPPI安全垫+塔勒布杠铃。**6/16 两台引擎入宪(§13):破'永久空仓'退化解——目标仍是赚钱,路径=比市场更准(edge→正CLV→钱),校准/CLV 是钱的领先指标。情报工厂(挖信息差赚钱)+ 探索引擎(小注学习·三账户80/120/79.5·≤6元/轮)。** 6/14押澳洲胜22@5.15命中+91.3,池188.2→279.5。周二批四场全-EV→赚钱引擎签工单合法空仓;探索引擎首跑3注×2元max凸性(学费EV-1.74)。下一里程碑500(6/18),差220.5。",
  "daily": [
   {
    "d": "06-11",
    "pool": 200,
   ...
   },
   {
    ...
    "records": [
     ...
     "📊 当日已结3场:无持仓,池 279.5 不变(伊朗09:00待赛)"
    ]
   }
  ],
  "evLedger": [
 ...
 "slip":  {
  "title": "6月17日 · 周二批 · 探索引擎首跑(3注×2元=6元)",
  "status": "**探索注·R&D非赚钱注** · 两台引擎启用。四场让球+胜平负全 -EV(EV -5.6%~-15.3%)→今晚没有一场比市场准→无赚钱注=合法空仓。改出 3 笔 max 凸性学习注,测同一假设「我是否系统性高估强队大胜幅度」,守 6 元探索预算 / 地板 80 铁封。",
  "detail": "**为什么从「空仓」改成「出探索注」:** 旧框架「价值闸<1.10 就不买」在高效市场里机械输出永久空仓=退化解(都不买就不亏,但学不到任何东西、agent 永不进化)。新框架=两台引擎:①情报工厂(挖真信息差才出手赚钱)②探索引擎(为把预测器磨得比市场更准而出小注,产生已结算校准样本)。今晚四场实测全 -EV(对抗审查已枪毙全部 4 笔中段让负注:结算结果被平局/方差污染、单样本只更新 0.18bit、踩杠铃中段贴水),赚钱引擎合法空仓。改由探索引擎出手,选 max 凸性(长赔率天然封顶学费)、thesis 最干净的 3 笔各 2 元:①周二017 法国1:0@5.65=塞内加尔刚夺非洲杯、预选10场仅丢3球,我 λ法2.05 对顶级防线高估→法国被摁1球(测进球环境+强队压制力校准);②周二019 阿根廷1:0@5.60=Scaloni 管理梅西分钟+演练5后卫收缩、阿根廷保守控场1球无大胜动机(测动机该不该压 λ);③周二020 0:0@14.00=约旦亚洲杯亚军、三中卫摆大巴零封奥地利,max 凸性14x(测弱队防守 vs 进球环境)。诚实:篮总 EV=-1.74 元(-29%),这是学费不是收益,正当性在 3 条干净的已结算校准样本、不在赢钱;最坏全损 -6 元(池 279.5→273.5,地板 80 远在天边)。记分牌看校准度/进球偏差有没有改善,不看这 6 元输赢。宪法 §5「禁猜比分」就地修正:比分注从此仅允许作探索引擎 max 凸性学习注(≤2元/笔、thesis 前置、计入 6 元探索预算、永不作核心/价值注)——原禁令本意「别把真金白银压在模型最弱的比分维度」依然成立,只给小额凸性学习开一道闸,是两台引擎方向的直接推论。",
  "items": [
   {
    "num": "周二017",
    "pick": "比分 法国 1:0",
  ...
  "copyText": "周二(6/17)三注共6元:法国vs塞内加尔 比分1:0 2元 / 阿根廷vs阿尔及利亚 比分1:0 2元 / 奥地利vs约旦 比分0:0 2元",
  "reviewNote": "探索引擎首跑 · 护栏全过:单笔≤2元✓ 总≤6元探索预算✓ 凸性闸赔率≥2.5✓(5.65/5.60/14.0) thesis前置三件套✓ 多thesis并行(强制分散)✓ 地板80(279.5-6=273.5)✓ · 诚实:篮总EV-1.74元=学费、非赚钱注,正当性在校准样本不在收益;赚钱引擎今晚合法空仓(四场全-EV)"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
