window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月22日 · 周日整轮 · 72元(比乌核心+西班牙让2球彩票)",
  "status": "**校准闸定稿。** 锚:乌拉圭~70%/比利时~69%(model+市场+Elo一致的真favorite)、西班牙让2球净胜3+~52%(硬币·只进彩票腿)。埃及跳过(Elo46% vs市场61%打架·信号不干净·选择性非空仓)。①②贴水热门单买负EV,价值在方向准+串关放大+参与。(17:11:西让2 1.71→1.61,3串赔率已更新)",
  "detail": "周日3注72元:①乌拉圭胜单24@1.30(唯一可单买的稳腿) ②2串1比×乌32@1.66(核心,两个~70%) ③3串1比×乌×西班牙让2球16@2.68(彩票,西让2~52%是硬币不当核心)。全中+55.2,全挂-72。西班牙胜平负未开盘,开了可能有更优买法。\n★20:11情报:乌拉圭缺Araujo+De Arrascaeta、比利时缺Doku(病)+Debast且首战1-1平埃及。均公开伤缺=已price→校准不砍favorite,锚1.30/1.28不变;比利时是两核中略shaky但仍69%。037西班牙胜平负仍未开。",
  "items": [
   {
    "num": "周日039",
    "pick": "乌拉圭胜(主胜)",
  ...
  "copyText": "周日这轮,一共买 72 块:\\n① 乌拉圭 vs 佛得角 → 买 乌拉圭赢,24 块\\n② 比利时赢 + 乌拉圭赢,串一起买,32 块\\n③ 比利时赢 + 乌拉圭赢 + 西班牙让2球赢,串一起买,16 块\\n\\n谢谢!",
  "reviewNote": "✓ 校准闸过:锚已报、谁赢vs赢几个分离(西让2按52%进彩票)、埃及Elo分歧选择性跳过、仍给picks不空仓。乌拉圭039单关had=1可单买。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
