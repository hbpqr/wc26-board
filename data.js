window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月20日 · 周五批 · 押我们最准的预测·真钱40元",
  "status": "**真钱 40 元 · 换框架了:押预测、去参与,不再0元。** 今晚押 agent 最有把握的两个预测:①摩洛哥胜(更强+苏格兰防守型低比分,模型55%)②巴西大胜海地(真鱼腩,让-2净胜3+)。跳过029(普利西奇缺阵+澳洲求平=美国赢难)/032(五五开)。",
  "detail": "**换框架(黄斌反复要的):agent 的活=把比赛预测准+给能下的单,不是算CLV劝空仓。** 今晚押我们最有把握的两个预测——**①核心:摩洛哥胜 @1.52(20元)**:摩洛哥更强、苏格兰防守型、Under2.5低比分,模型客胜55%,我刚扒的多家预览也看摩洛哥小胜=最稳的pick。**②凸性上车票:2串1 摩洛哥胜 × 巴西让-2 @2.48(20元)**:海地是真鱼腩(比逼平巴西的摩洛哥弱得多)、巴西强,大概率净胜3+;两个最准预测串起来搏个量级。**跳过**:029美国(普利西奇缺阵+澳洲只需平局会摆大巴,美国赢难度比模型高、平局风险大,不押)、032土耳其(46%五五开,没把握)。共40元(池280的14%),地板80纹丝不动;摩洛哥单关中=+10.4,2串1全中=+29.6,两个都中≈+40。**训练重心也换了:从今往后盯的是'预测命中率'(pick准不准),不是CLV——你要的'做准一点'。**",
  "items": [
   {
    "num": "周五030",
    "pick": "客胜 · 摩洛哥胜",
  ...
  "copyText": "周五(6/20)两注共40元:① 苏格兰vs摩洛哥 买摩洛哥胜(客胜) 20元 ② 2串1:摩洛哥胜 + 巴西让球-2(巴西净胜3球及以上) 20元,谢谢!",
  "reviewNote": "换框架=押预测不劝空仓:核心摩洛哥胜@1.52(模型55%+情报支持)+凸性2串1摩洛哥×巴西让-2。跳过029(普利西奇缺阵)/032(五五开)。40元参与,地板80安全。训练重心改为预测命中率。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
