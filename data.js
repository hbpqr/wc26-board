window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月20日 · 周五整轮 · 串关搏量级·总46元",
  "status": "**这一轮总 46 元(串关版,你要的高赔率)** · 摩洛哥胜单关保底16 + **3串1(摩×美×巴让-2)@3.48 主力24** + 4串1(+土耳其)@6.19 彩票6。三核心串中=+59.5,四场全中=+90+。",
  "detail": "**串关版整轮买法(总46元·池280的16%·地板80安全):**\n①**摩洛哥胜 单关 @1.50 · 16元(保底)**:最稳的pick单独保一注,串挂了它还能回点。\n②**3串1 摩洛哥胜×美国胜×巴西让-2 @3.48 · 24元(高赔主力)**:三个最有把握的预测串一起(普利西奇已确认首发→美国可串),全中回 83.5、净 **+59.5**;命中率约20%(三场各55-62%)。\n③**4串1 摩×美×巴×土耳其 @6.19 · 6元(彩票小注)**:再加上五五开的土耳其,赔率翻到6.19,全中回37、净+31,但命中率仅~9%——只当小额彩票博一把。\n**为什么这么配**:串关赔率高(你要的),但全中要求高=命中率低;所以摩洛哥单独留个保底,3串1做主力(赔率/命中平衡最好),4串1只小注当彩票。**土耳其(五五开)只进彩票腿,不单买**。\n四场全中≈+90,三核心中≈+57,地板80稳。要更激进(全压串/加金额)或更稳(只买2串1)你说,我背着改。",
  "items": [
   {
    "num": "周五030",
    "pick": "摩洛哥胜(客胜) · 单关保底",
  ...
  "copyText": "周五(6/20)串关共46元:① 苏格兰vs摩洛哥 买摩洛哥胜 16元(单关)② 3串1:摩洛哥胜+美国胜+巴西让球-2(净胜3+) 24元 ③ 4串1:摩洛哥胜+美国胜+巴西让-2+土耳其胜 6元。谢谢!",
  "reviewNote": "串关版整轮46元:摩洛哥胜单关16保底+3串1摩美巴让-2 @3.48 主力24+4串1+土耳其@6.19彩票6。普利西奇确认首发→美国可入串。高赔=高要求低命中,3串1做主力平衡最好。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
