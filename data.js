...
window.DASH_DATA = {
  ...
  todayMatches: [
      ...
      },
      {
          ...
          "note": "苏格兰被看好(集成65.4%客胜),海地世界排名靠后;实时比分见红色「进行中」。无持仓(苏格兰胜赔率贴水无正EV)。"
      },
      {
          "num": "周六008",
          "group": "B组",
          ...
          "note": "本轮唯一持仓:澳大利亚胜22元@5.15(土耳其三主力伤疑,我们认为澳洲被市场低估)。实时比分见红色「进行中」。"
      }
  ],
  ...
  focus: [
      {
                ...
                "scores": [],
                "wdlValue": [],
                "verdict": "德国是碾压级本命(集成92%),库拉索是本届实力最弱之一。竞彩未开盘,一旦开出德国胜赔率会极低(预计1.05上下)基本无肉;真正的机会大概率在让球盘或大球,等开盘后单独评估。胜平负单关不值得碰。",
                "radarWhy": [
                          {
                                    "dim": "状态",
                                    "h": 9,
      ...
      },
      {
                ...
                "verdict": "荷兰纸面略优(集成50.6%),但日本是现代化的快速反击硬骨头,不好啃。三个选项价值都在0.87-0.90、全是负EV,市场定价高效——本场无正期望票,建议放过。",
                "radarWhy": [
                          {
                                    "dim": "状态",
                                    "h": 7,
      ...
      },
      {
                ...
                "verdict": "有意思的一场:厄瓜多尔客场反被看好(集成40.4%客胜>科特迪瓦27%),典型势均力敌的胶着局,平局概率也高(32.6%)。三项价值0.86-0.91全负EV,无肉。",
                "radarWhy": [
                          {
                                    "dim": "状态",
                                    "h": 6,
  ...
  // ---------- 明日下单 · 21:00最终版 ----------
  slip: {
      "title": "本轮(6/14)· 澳洲单关 · 22元 · 12:00开赛",
      "status": "📌 这是本轮(6/14)的票,不是上面6/15的。澳大利亚胜22元@5.15(胜平负,价值1.16),土耳其三主力伤疑、澳洲被市场低估,是全轮唯一正EV票——已砍掉20:30管家那3张靠猜比分的虚价值票(模型猜比分0/3)。⚠️ 出票前看土耳其首发,恰尔汗奥卢意外首发则减到16元。\n\n下一轮(6/15·今晚21:00买):四场全无正期望票——荷兰胜0.90/瑞典胜0.90/厄瓜多尔0.89全在贴水,德国vs库拉索92%但竞彩没开盘(开出也无肉);市场定价高效,这轮大概率空仓,20:30终盘再复评。",
      "items": [
          {
              "num": "周六008",
              "match": "澳大利亚 vs 土耳其",
