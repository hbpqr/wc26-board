window.DASH_DATA = {
 ...
 "focus": [
  {
   ...
   "scores": [],
   "verdict": "🔴重估警示:瑞典在大状态(5-1血洗突尼斯·Gyökeres火力·小组头名),荷兰首战仅2-2平日本+Timber伤缺。荷兰胜60.8%偏乐观——瑞典是真对手,这是本轮最该重估/可砍的一注。"
  },
  {
   "num": "周六034",
   "home": "德国",
 ...
 "slip": {
  "title": "6月21日 · 周六整轮 · 纪律空仓 · 21:00 最终版",
  "status": "**纪律空仓。** 四场全部扫描完毕：033荷兰(最高value0.97)、034德国(value0.91·含瓦伊/恩迪卡情报tilt后约0.94)、035厄瓜多尔HHAD-2深让镜像(value0.96)、036日本(value0.88·久保/远藤缺阵tilt更低)。安全边际要求≥1.10，全部未达标。fade-favorite三场负CLV。宁可空仓，不在噪声里送钱。",
  "detail": "周六最终版复核(20:31)：\n• 033 荷兰vs瑞典：集成60.4%/22.3%/17.3%。HAD主胜@1.53×0.604=0.92；HHAD让负@2.19 value=0.89。伊萨克已确认健康首发(06-20双源)。fade-favorite：竞彩平3.83 vs Poly公平4.27=负CLV(-10.3%)，不下。\n• 034 德国vs科特迪瓦：集成67.9%/18.8%/13.3%。HAD主胜@1.34 value=0.91。瓦伊禁行+恩迪卡疑缺→tilt德国约70%×1.34≈0.94，仍<1.10。无Poly平局数据，无法验证CLV。\n• 035 厄瓜多尔vs库拉索：模型87.3%。竞彩HAD未开盘，HHAD(-2)让胜@1.85 value=0.96 edge+3.9pp。深让镜像雷区——模型净胜≥3尾部不可靠，pass。\n• 036 突尼斯vs日本：集成13.7%/22.0%/64.2%。客胜@1.37 value=0.88。久保(左膝确认伤缺)+远藤(全程缺)→日本进攻tilt后value更低。突尼斯换帅Renard。fade-favorite：竞彩平4.05 vs Poly公平4.31=负CLV(-6%)，不下。\n情报工单三条签字：(a)全四场所有盘口edge均<安全边际1.10 (b)五路情报交叉，硬信息差(瓦伊/久保/远藤)已量化，无正CLV边 (c)影子book本轮四场概率已记入model_state。",
  "items": [],
  "summary": {
   "stake": 0,
   "evLow": 0,
