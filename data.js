window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月20日 · 周五批 · 0元(fade 没过 CLV 金标准)",
  "status": "**真钱 0 元** · 多源深查推翻了 fade 押平:竞彩平局价(3.83)比国际盘 sharp 公平价(4.46)还短=**负 CLV=按金标准不是边**。竞彩和 sharp 都把平局定在 22-29%、两市场一致,没有'竞彩低估平局'这回事;36% 是 28 场小样本方差。**赌整个市场(含sharp)都错=不下。**",
  "detail": "**为什么从 24 元砍到 0(多源+站外学习深查):** ①站外学习硬结论(Trademate/datagolf/Pinnacle):**sharp 收盘线(Pinnacle/Polymarket)=真概率最好估计,CLV(下注价 vs sharp 收盘价)是唯一硬边标准,拿到比 sharp 短的价=负CLV=必输**。②今晚三场多源对照:竞彩平局隐含 26-31% vs Polymarket(sharp)22-29%,**两市场一致、竞彩平局价甚至比 sharp 公平价更短(029: 竞彩3.83 < sharp公平4.46)**→押平是负CLV。③所以 fade '边'根本不是'竞彩比 sharp 蠢',是纯赌'实际36% > 全市场22-26%'=赌整个市场错,28场(10平 vs 期望6-7)在方差内,sharp 的 23% 才是真概率更好估计。④动量:Poly 平局 +0.2~+0.7pp(微朝平)但太小、且竞彩030线 3.42→3.47 反向背我们。**纠正后的真 fade 标准(写进台账):只在'竞彩平局赔率 > sharp 公平赔率'(正CLV)时押平——今晚三场全是反的(竞彩更短),全不合格→0元。** 这是我一直缺的多源+趋势深度,黄斌点对了。",
  "items": [],
  "summary": {
   "stake": 0,
   "evLow": 0,
   ...
   "keyScenarios": [
    {
     "label": "fade没过CLV金标准·空仓",
     "pnl": 0
    }
   ]
  },
  "matrix": [],
  "copyText": "周五(6/20)不下注,谢谢!",
  "reviewNote": "多源+站外学习深查:fade押平负CLV(竞彩平局价比sharp公平价短)=按金标准不是边;竞彩与sharp对平局定价一致(22-29%),36%是小样本方差。纠正fade标准=只在竞彩平局价>sharp公平价(正CLV)时押。今晚全不合格→0元。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
