window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月20日 · 周五整轮 · 纪律空仓 · 21:00最终版",
  "status": "✅ 签名空仓 · 4场全扫价值全<1.10 · fade-favorite CLV负 · 地板279.5完整",
  "detail": "**终盘重算(20:31最终版)· 4场全过价值闸 → 全不过 → 纪律空仓**\n\n四场价值汇总：\n- **029 美国 vs 澳大利亚**：HAD 主0.90/平0.86/客0.87；HHAD(-1)让胜1.02 · edge+5.4pp — 仍<1.10 ✗\n- **030 苏格兰 vs 摩洛哥**：HAD 主0.98/平0.90/客0.85；含Bono疑缺tilt重跑苏格兰价值0.94 — 仍<1.10 ✗\n- **031 巴西 vs 海地**：竞彩HAD未开盘；HHAD(-2)让胜0.92 — 深让镜像雷区，仍<1.10 ✗\n- **032 土耳其 vs 巴拉圭**：HAD 主0.84/平0.91/客0.96；HHAD(-1)让胜1.04 · edge+4.3pp — 仍<1.10 ✗\n\n**情报终核(20:30最新)：**\n- 029 普利西奇：Pochettino称\"much better\"，夜间最终决定；Polymarket线仅漂-0.3pp=市场已定价→无新edge\n- 030 Bono疑缺(Morocco GK doubtful)：苏格兰赔率已从5.10→5.55反映，市场已消化；贝叶斯加权(50%Bono出战 × 17.7% + 50%缺席 × 20%) = Scotland预期赢概率18.9% × 5.55 = 1.049 < 1.10 ✗\n- 031 巴西：无大轮换确认，深让-2=镜像，不下\n- 032 土耳其/巴拉圭：Paraguay多伤(Almiron疑/Sosa伤/Caballero出)→ 压低巴拉圭赢概率 → 无助任何买点\n\n**fade-favorite终核(§14)：**\n- 029 美国 conf62.3%≥60%，但CLV: 竞彩平3.90 vs Polymarket公平赔率4.63 → 负CLV → 跳过\n- 031 巴西 conf89.8%，排除(海地=真鱼腩，宪法明示) → 跳过\n- 本轮无正CLV fade-favorite注\n\n**情报工单签字(§13.5合法空仓三条)：**\n(a) ✅ 全盘口已扫：4场×胜平负+让球，价值全<1.10\n(b) ✅ 硬信息差明确\"无\"：Pulisic/Bono皆为\"疑\"非\"确认缺\"，市场已定价\n(c) ✅ 影子book记满：周五029-032集成概率已落盘\n\n空仓 = 满分动作。地板279.5，等下一个真edge。",
  "items": [],
  "summary": {
   "stake": 0,
   "evLow": 0,
  ...
  "copyText": "周五(6/20)这一轮不买，所有场次价值分均低于1.10安全边际，空仓。谢谢！",
  "reviewNote": "✓ 已独立复核 20:43 ｜ 草稿合规，无删改。items=[]空仓；4场价值全<1.10（029 HHAD让胜最高1.02 / 030主胜最高0.98 / 031未开盘让胜0.92 / 032客胜0.96）；fade-favorite 029 CLV负跳过、031排除鱼腩；情报工单三条签字齐；池279.5>地板80，仓位0≤25%上限。§3/§7/§13.5全过。空仓=满分动作。⚠️旁注：todayMatches 029/030/031 predManual仍留旧草稿\"见slip\"措辞与最终空仓不符，不影响放行，建议主会话下轮顺手更新。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
