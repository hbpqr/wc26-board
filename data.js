window.DASH_DATA = {
 ...
 "slip": {
  "title": "7月4日 · 独立复核 · 空仓(草稿已过期作废)",
  "status": "empty",
  "detail": "复核否决:草稿(20:46刷新)自称『086/087/088三场均在售未开打』并对088哥伦比亚vs加纳押平@4.50 4元,但比对 todayMatches 实时状态——086澳大利亚vs埃及(07-04 02:00)、087阿根廷vs佛得角(07-04 06:00)、088哥伦比亚vs加纳(07-04 09:30)三场均已 status:finished 完赛(实际1:1/3:2aet/1:0)。088实际1:0非平,原草稿票已100%确定性输且比赛早已结束根本不可能出票——草稿基于过期批次生成,判定整批失效,全部作废,改为空仓。真实betRound=周六(089加拿大vs摩洛哥 07-05 01:00 Selling·090巴拉圭vs法国 07-05 05:00 Selling,均未开打),尚未见基于089/090的合规slip,待主会话重新生成。资金池=cashNow250.55+pendingStake0=250.55,本轮空仓不变。",
  "items": [],
  "summary": {
   "stake": 0,
   "evLow": 0,
  ...
  "matrix": [],
  "copyText": "老板你好，竞彩足球，7月4日：\n\n草稿批次(086-088)已全部完赛失效，今晚无可执行下单方案，空仓。\n\n谢谢！",
  "reviewNote": "✓ 独立复核 20:41 · 否决草稿:086/087/088均已完赛(088实际1:0非平·原押平票已确定性败且比赛早结束不可能出票)，判定为过期批次全部作废，改为空仓；真实betRound=周六089/090(Selling·未开打)，待主会话基于089/090重新生成slip · 按§0/§3/§11纪律安全兜底为空仓 · node --check data.js 通过"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
