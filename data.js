window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月17日 · 周二批(017-020) · 池279.5 · 空仓",
  "status": "**空仓** · 周二批(017-020)×全盘口已扫+情报深核,无一达买入门槛(≥1.10),§11合规,纪律执行✓",
  "detail": "**周二批四场(017-020)×全盘口扫完+逐场情报深挖,无一达买入门槛(≥1.10),按宪法§3/§5杠铃策略空仓。** 逐场记录：①周二017法国vs塞内加尔(06-17 03:00)：让球(-1·浅让主战场)让胜value0.94(edge+2.6pp)——情报核破：用户原以为「姆巴佩带伤首发」实为**伪信息差**(4月腘绳肌已痊愈、零伤停标注)；而塞内加尔刚夺2026非洲杯、预选10场仅丢3球、防线坚如磐石→「法国轻松净胜2」被模型高估,典型镜像陷阱,信市场不信模型,空仓；②周二018伊拉克vs挪威(06:00)：挪威让+2=**深让镜像雷区**,哈兰德/厄德高均健康首发无信息差,Opta挪威胜77.4%但让2对防反铁桶门槛极高,§6深让信市场跳过；③周二019阿根廷vs阿尔及利亚(09:00)：让球(-1)让胜value0.90(edge+1.4pp)——挖到真软信号但**方向对出手不利**：Scaloni明确「管理梅西出场时间」+演练5后卫收缩→阿根廷无追大胜动机；本塞巴尼伤缺是公开旧闻、市场已price-in,空仓；④周二020奥地利vs约旦(12:00)：让球(-1)让胜value0.94(edge+3.3pp)——四场最接近门槛,约旦头号射手Alnemat十字韧带赛季报销确利好奥地利,但属公开信息已price-in;约旦亚洲杯亚军+三中卫防守纪律使「净胜2+」非高确定性,仍未过闸,空仓。§11合规：已扫每场×每盘口(胜平负+让球+比分),无漏检。**结论:四场场外硬信息差=0,我额外挖到的两条真软信号(梅西分钟管理/塞内加尔强防)反而都指向热门不会大胜——这正是「深让大热门该信市场」的标准情形。宁可错过,绝不在噪声里送钱。**",
  "items": [],
  "summary": {
   "stake": 0,
   "evLow": 0,
  ...
  "matrix": [],
  "copyText": "周二(6/17)四场没有符合要求的票，不买，谢谢！",
  "reviewNote": "✓ 已独立复核+情报深核 ｜ 周二批(017-020)四场×全盘口(HAD+HHAD)全扫：最高value=017法国/020奥地利让胜0.94(<1.10跳过)；018挪威深让+2镜像区跳过；019阿根廷让胜0.90；情报研判四场场外硬信息差=0(姆巴佩伪信息/本塞巴尼·Alnemat均公开已price-in)，且挖到的真软信号(Scaloni保守/塞内加尔强防)方向反而下修热门大胜面；空仓正确，放行"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
