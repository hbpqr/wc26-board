window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月24日 · 周二预研 · 押平局凸性版 16元(边偏薄·小注)",
  "status": "**§16押被低估的平局·过§17四层验证后小注。** 两个短赔热门的平局边:047克罗地亚1.33客场短赔vs巴拿马主场desperate(经典逼平局面·可单)、048哥伦比亚1.35vs刚果金(刚果金有实力·只串)。葡萄牙/英格兰太强(像阿根廷)不押。**周一押平局第1负(没whipsaw·小注稳住·§17.6连3亏才停)·这轮边薄故只16元守地板**。045/046胜平负未开·临场重核。",
  "detail": "周二2注16元(押被低估的平局·四层验证过):①巴拿马对克罗地亚打平 单10@4.30(克罗地亚客场短赔+巴拿马主场拼·§17:事件90min同口径/扣vig后value~1.2正/可单) ②2串1巴拿马平×哥伦比亚平 6@16.77(双平彩票)。最好+127.6,最差-16。防伪正确:这是有理由的短赔热门逼平·非纯爱上中间结论·但边薄故小注。",
  "items": [
   {
    "num": "周二047",
    "pick": "巴拿马对克罗地亚 打平",
  ...
  "scenarios": [
   {
    "label": "巴拿马克罗地亚打平+哥伦比亚刚果金打平(双平全中)",
    "hit": "中2注",
    "prob": 6,
    "win": [
     0,
  ...
  "copyText": "周二预研,小注买2注(等我21:00终版):\\n① 巴拿马vs克罗地亚 打平,10块\\n② 巴拿马打平 + 哥伦比亚vs刚果金打平,串一起买,6块\\n谢谢!",
  "reviewNote": "✓ §16押平局+§17四层验证过(事件90min同口径/价可得/扣vig后value正/串关组合)·防伪正确(短赔热门逼平有理由非伪正确)·边薄小注16守地板。047可单/048只串。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
