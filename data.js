window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月23日 · 周一整轮 · 杠铃凸性版 24元(押被低估的平局,翻转打法)",
  "status": "**§16杠铃翻转:不再押短赔热门赢,改押被低估的平局尾。** 阿根廷1.30/阿尔及利亚1.38=极端短赔热门(本周连平3个的同类),平局市场只price~22-24%,但这届实际33-36%(§14·被系统性低估)。小注、总敞口小、守地板80。挪威-塞内加尔等首发再定,约旦掀翻@6.20不碰(说不出为何低估)。",
  "detail": "周一2注24元(全是被低估的平局尾·凸性):①阿根廷对奥地利打平 单14@4.30(短赔热门被低估的平·§14旗舰·按33%实际平局率value≈1.42正期望) ②2串1阿根廷平×约旦阿尔及利亚平 8@17.63(两短赔热门同轮被逼平·双平彩票)。最好全中+185.8,最差-24。这是翻转打法第一版:平时小亏、热门被平时大赚。\n★20:00校准:阿根廷首战3-0梅西帽子+本场首发不轮换状态火爆,奥地利会压上攻(非摆大巴)→这场真实平局概率<33%平均值(估~25%),阿根廷平value从1.42降到~1.08(真彩票非+EV锁)。按校准不砍(情报已price),但如实标小注。考虑21:00把部分核心挪到挪威-塞内加尔(五五开·平局更可能·待查哈兰德)。\n★20:13:挪威-塞内加尔查实=开放对攻局(哈兰德首发+塞内加尔攻击群+两队都需赢)·平@3.40定价公平·无§14边→不押(§16.7)。044阿尔及利亚才是最好的平局边(1.38但首战0-3被梅西血洗·状态崩·约旦主场·只能串)→终版考虑加重044那条权重。挪威不纳入。",
  "items": [
   {
    "num": "周一041",
    "pick": "阿根廷对奥地利 打平",
  ...
  "copyText": "周一这轮,小注买2注:\\n① 阿根廷 vs 奥地利 → 买 打平,16块\\n② 阿根廷打平 + 约旦vs阿尔及利亚打平 串一起买,8块\\n谢谢!",
  "reviewNote": "✓ 已独立复核 20:47 ｜ 修正1处:copyText金额14→16块(与items.stake=16/summary.stake=24一致)。逐项核查:①041平@4.30·value=0.33×4.30=1.42≥1.10✓·had.single=1可单✓·16元偶数✓ ②2串1(041+044平)@17.63·value=1.92≥1.10✓·041/044均had.allUp=1✓·8元偶数✓。总注24=8.5%池·最坏258.55>>地板80✓。无比分票·无同场反向·无短赔热门串·§16杠铃凸性合规。草稿整体合规,放行。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
 ...
 "training": {
  ...
  "headline": "已喂 40 场预测 · 集成 Brier 0.571 vs 市场去水 0.5452（仍未跑赢）· 只比随机0.667好一点（地板线,非alpha）",
  "lesson": "**28场复盘硬结论(诚实版):** 集成 Brier 0.571 **仍没跑赢市场去水(0.5452)**——模型暂无可证明的边。它只比'瞎猜'(随机0.667)好一点,那是地板不是本事。平局占36%(异常高)模型从不押平→10个自动判错卡死命中率;回测所有补救都≤57%,平局事前分不出来。**边在纪律和情报、不在模型方向**(可迁股市:高效市场里纯模型必收敛到市场)。⚠️别把'跑赢随机'当 alpha——真市场CLV还在攒(竞彩收盘价未留存),没有真CLV前'有没有边'仍是自说自话。",
