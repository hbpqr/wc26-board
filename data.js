window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月21日 · 周六整轮 · 已下注72元(4张票·票面为准)",
  "status": "**已出票72元(见持仓区)·还剩28元建议加投。** 缺口:德国(最强·68%)只通过德日串/德日厄串兑现,全靠日本赢(久保伤缺有风险)。**剩28元建议补两张给德国接上不依赖日本的路径:①德×荷 2串1 18元@2.05→中36.9 ②德×厄让-2(净胜3+) 2串1 10元@2.48→中24.8**。补后德国赢的情况下约93%至少中一注。省事版:只出德×荷28元@2.05→中57.4。荷兰01:00开球前补上。",
  "detail": "已下注4票(72元):①荷单12@1.53 ②日单20@1.37 ③2串1德×日24@1.836 ④3串1德×日×厄净胜4+(让-3)16@6.24。\n★剩28元加投建议:德×荷18@2.05 + 德×厄让-2(净胜3+)10@2.48,给德国补两条不靠日本的兑现路径,对冲久保伤缺。",
  "items": [
   {
    "num": "周六033",
    "pick": "荷兰胜·单关【已出票】",
  ...
  "copyText": "本轮已出票72元(荷单12+日单20+2串1德日24+3串1德日厄16)。复盘:建议补德×荷2串1约16元对冲日本风险。",
  "reviewNote": "✓ 已按票面核对入持仓(72元4票),厄腿查实=让-3净胜4+@3.40。提示:德国仅经德日串兑现,缺日本-独立路径,已建议加德×荷对冲。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
