window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月21日 · 周六整轮 · 预研建议(赛前持续更新到定稿)",
  "status": "**⚠️ 这是赛前预研建议,不是最终单——会随赔率/阵容持续更新,以定稿为准。** 当前预判:厄瓜多尔(87%最强·竞彩待开盘)、德国(67%)、日本(63.6%)、荷兰(60.8%)。诚实:4场都是短赔大热门、单关负EV(竞彩vig~13%);按押预测打法给picks。**厄瓜多尔一开盘就纳入、方案会重构、上限更高。**",
