window.DASH_DATA = {
 ...
 "holdings": {
  ...
  "scenariosTitle": "周六整轮·已下注72元(4张票·票面为准)",
  "scenarios": [
   {
    "label": "全胜:德日荷赢+厄让中",
    "pnl": 117.64,
 ...
 "slip": {
  ...
  "status": "**已出票72元(见持仓区)。** 复盘建议:德国是本轮最强预测但只能串,你的票里德国只通过【2串1德日】和【3串1德日厄】兑现——**都得日本同时赢**;日本久保伤缺有风险,若日本没赢,德日两串(40元)全死,只剩荷单回血。建议补一张【德×荷 2串1 约16元】给德国第二条路径,对冲日本风险。",
  "detail": "已下注4票(72元):①荷兰胜单12@1.53 ②日本胜单20@1.37 ③2串1德×日24@1.836 ④3串1德×日×厄让球16@6.24(厄腿票面3.40·玩法待你与老板确认)。最高全中+117.64,全挂-72。\n复盘缺口:德国(最强·68%)无脱离日本的兑现路径→建议加德×荷2串1对冲日本久保风险。",
  "items": [
   {
    "num": "周六033",
    "pick": "荷兰胜·单关【已出票】",
  ...
  "reviewNote": "✓ 已按票面核对入持仓(72元4票)。提示:德国仅经德日串兑现,缺日本-独立路径,已建议加德×荷对冲。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
