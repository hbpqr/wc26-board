window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月21日 · 周六整轮 · 大胆版 88 元(可现在出,厄瓜多尔开盘后单独补)",
  "status": "**这批 88 元可以现在出**(德国28+日本20+2串1 24+3串1 16)。**厄瓜多尔87%是真大注、但竞彩待开盘(08:00),开盘后我单独发你做最大核心。** 诚实:开盘场短赔负EV,大胆=把量级压在最有把握的预测上。地板80安全(最差池→240)。",
