window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月21日 · 周六整轮 · 100元(德国只能串·已按单关规则重排)",
  "status": "**已按竞彩单关规则重排。** 官方接口核实:034德国(胜平负+让球)both single=0 → 只能串,不能单买;033荷兰主胜、036日本客胜 single=1 可单买;035厄/让球只能串。原①德国28元单关无法出票,已拆解:德国改走两条串(德×日核心 + 德×荷对冲日本久保风险)+3串1,日本/荷兰保留单关。",
  "detail": "周六重排逻辑(单关资格已查官方poolList.single):\n• 德国=本轮最强预测(7-1血洗·67.9%)但胜平负/让球都不能单买,只能串 → 给它两条搭档路径(配最强的日本=核心40元、配荷兰=对冲12元),不把德国的命全压在日本一人身上(久保伤缺有风险)。\n• 日本(036客胜)、荷兰(033主胜)可单买 → 保留单关,独立回血。\n• 厄瓜多尔只开让球(-2)且只能串 → 进3串1彩票腿。\n• 代价说清:德国若孤军赢(日荷都输)这单亏,这是单关禁令的硬约束,无法消除,只能用两条搭档+两张单关把覆盖做厚。",
  "items": [
   {
    "num": "周六036",
    "pick": "日本胜(客胜·可单关)",
  ...
  "copyText": "周六 6/21 这一轮,一共买 100 元:\\n① 突尼斯 vs 日本 → 买 日本赢,20 元\\n② 荷兰 vs 瑞典 → 买 荷兰赢,10 元\\n③ 德国赢 + 日本赢 串一起买,40 元\\n④ 德国赢 + 荷兰赢 串一起买,14 元\\n⑤ 德国赢 + 日本赢 + 厄瓜多尔赢3球以上 串一起买,16 元\\n\\n谢谢!",
  "reviewNote": "✓ 按单关规则重排:德国(034)经官方poolList.single=0确认不能单买,已全部走串;日本(036)/荷兰(033)single=1保留单关。5注共100元,无不可出票项。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
