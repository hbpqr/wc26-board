window.DASH_DATA = {
 ...
 "todayMatches": [
  ...
  },
  {
   ...
   "note": "挪威vs法国(I组末轮·双方均已6分出线·低动机)。法国临时主帅居伊·斯特凡执教(德尚因母亲去世暂离)；挪威Ryerson伤疑。两队出线已定·动机分析广开平局/冷门空间。模型集成客胜69.7%。"
  },
  {
   "num": "周五062",
   "round": "周五",
   ...
   "note": "塞内加尔vs伊拉克(I组末轮·双方均积3分·需赢方可出线)。塞内加尔门将Mendy韧带伤出局·Mory Diaw替首发；伊拉克Hussein(本届唯一进球)受伤疑缺。双方均有强动机·塞内加尔实力更强。模型集成主胜79.5%。"
  },
  {
   "num": "周五063",
   "round": "周五",
