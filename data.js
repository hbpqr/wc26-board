window.DASH_DATA = {
 ...
 "slip": {
  "title": "6月20日 · 周五整轮 · 情报调整·总52元",
  "status": "**这一轮总 52 元(情报调整:海地不是鱼腩→巴西让-2从核心降成彩票)** · 核心改两个 team win:摩洛哥胜+美国胜(普利西奇首发);稳串2串1摩×美;巴西让-2只留3串1彩票腿。032土耳其跳过。",
  "detail": "**18:48 loop 扒到的关键情报+调整(海地竞争力被低估了):** 最新预览(Yahoo/SI/Sports Mole)——①**海地不是真鱼腩**:首战narrow负苏格兰但edged possession、xG打平=能踢能防;②**巴西首战vs摩洛哥踢得sluggish、险些没赢**。两条合起来=**巴西赢海地大概率,但'净胜3+(让-2)'风险比我之前估的大得多**→我把巴西让-2从核心降级成只留3串1的彩票腿,不再单押。\n**调整后整轮52元:**\n①**030 摩洛哥胜 @1.50 · 16元(核心)**:摩洛哥远强于苏格兰(苏格兰跟海地一个级别),最稳。\n②**029 美国胜 @1.45 · 16元(核心)**:普利西奇确认首发+全主力,主场强favored。\n③**2串1 摩洛哥×美国 @2.18 · 12元(稳串)**:两个team win串,不碰风险大的巴西让-2,全中+14.2。\n④**3串1 摩×美×巴西让-2 @3.48 · 8元(彩票)**:想赌巴西也大胜就这8元小注,已知let-2有风险=只当彩票。\n⑤**032 土耳其 跳过**(五五开)。\n两核心+稳串中≈+29,加彩票全中≈+49,地板80稳。**这就是loop该干的:扒到海地能竞争→把巴西让-2降级,不硬押。**",
  "items": [
   {
    "num": "周五030",
    "pick": "摩洛哥胜(客胜)",
  ...
  "copyText": "周五(6/20)这一轮共52元:① 苏格兰vs摩洛哥 买摩洛哥胜 16元 ② 美国vs澳大利亚 买美国胜 16元 ③ 2串1:摩洛哥胜+美国胜 12元 ④ 3串1:摩洛哥胜+美国胜+巴西让球-2(净胜3+) 8元。巴西不单买、土耳其不买,谢谢!",
  "reviewNote": "情报调整(海地非鱼腩+巴西首战sluggish)→巴西让-2从核心降彩票腿。整轮52元:摩洛哥胜16+美国胜16核心+2串1摩美12稳串+3串1含巴让-2 8彩票;032跳过。押预测,地板80安全。"
 },
 "calibration": {
  "stats": {
   "direction": "3/5",
