...
window.DASH_DATA = {
  ...
  bankroll: {
    ...
    note: "2万是北极星(方向),不是赌注(KPI)。架构=CPPI安全垫:本金200只碰最低损耗的核心票,高方差票只花赚来的钱;垫厚则攻,垫薄则守,棘轮把每个台阶变成新保本线。当前资金池 188.2(全现金,美巴已结算),仍低于保本线 200,防御模式持续:倍数仓清零、价值仓减半,核心慢攻修复安全垫。",
  ...
  todayMatches: [
      ...
      },
      {
          ...
          "note": "博巴迪利亚7分钟乌龙+巴洛贡双响(31'、45'+5')奠定半场3-0;毛里西奥73分钟扳回一城;终场3:1。美国主场首秀大胜,方向预测正确(集成53.2%主胜);美国胜票24@1.78中,回收42.7。"
      }
  ],
