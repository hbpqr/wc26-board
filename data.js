window.DASH_DATA = {
 ...
 "slip": {
  ...
  "status": "**校准闸定稿。** 锚:乌拉圭~70%/比利时~69%(model+市场+Elo一致的真favorite)、西班牙让2球净胜3+~52%(硬币·只进彩票腿)。埃及跳过(Elo46% vs市场61%打架·信号不干净·选择性非空仓)。①②贴水热门单买负EV,价值在方向准+串关放大+参与。",
  "detail": "周日3注72元:①乌拉圭胜单24@1.30(唯一可单买的稳腿) ②2串1比×乌32@1.66(核心,两个~70%) ③3串1比×乌×西班牙让2球16@2.85(彩票,西让2~52%是硬币不当核心)。全中+57.9,全挂-72。西班牙胜平负未开盘,开了可能有更优买法。",
  "items": [
   {
    "num": "周日039",
    "pick": "乌拉圭胜(主胜)",
