...
window.DASH_DATA = {
  ...
  slip: {
      ...
      "status": "今晚要买的是 6/15 这一轮,四场跑完——**没有一张到买入门槛(value≥1.10)**:荷兰胜0.90、瑞典胜0.90、厄瓜多尔0.89 全在贴水(负EV或刚过平),德国vs库拉索我们算92%但竞彩未开盘(开出也是1.05无肉)。按塔勒布安全边际+杠铃策略,**这轮空仓**——没缝硬塞=慢性失血。今晚20:30终盘我再扫一遍,真出现≥1.10的凸性机会才出手。(本轮澳土22元已在「持仓账本」在场,等12:00开赛)",
      "items": [],
      "summary": {
          "stake": 0,
          "evLow": 0,
