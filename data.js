window.DASH_DATA = {
 ...
 "focus": [
  ...
  },
  {
   ...
   "wdlValue": [],
   "scores": [],
   "verdict": "⚠️竞彩未开盘·预研模式:厄瓜多尔87.3%远碾压库拉索(本轮最强pick)。开盘后A入场、必重跑predict.py;很可能做成核心或让球彩票腿,届时方案重构、上限更高。"
  },
  {
   "num": "周六036",
   "home": "突尼斯",
 ...
 "slip": {
  "title": "6月21日 · 周六整轮 · 预研·大胆版(赛前持续更新,厄瓜多尔开盘后并入做大核心)",
  "status": "**⚠️ 预研·大胆版(非最终单,赛前持续更新到定稿)。** 按你「拿得准就多投」调大:德国28(最稳开盘核心67%)+日本20(64%)+2串1 24+3串1 16=**88元**(池328·占27%·地板80安全)。**真·该下大注的是厄瓜多尔87%(远碾压库拉索),但竞彩待开盘(08:00)——它一开我做成最大核心,总盘升到~140。** 诚实:开盘场都是短赔负EV,大胆=押最有把握的预测放大量级,不是平摊乱加。",
